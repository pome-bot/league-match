...
## What is this?
<p>
このアプリでは、リーグ戦を管理することができる。グループを作成し、それぞれのグループで複数のリーグを組むことができる。このアプリの特徴は以下のとおり。
</p>

- グループ毎に複数のリーグ戦を組むことができる。
- リーグ戦の勝敗を記録できる。
- リーグ戦の試合順が自動で作成される。
- リーグ毎にコメントを投稿できる。
- ユーザーの試合成績を確認できる。
...
- このおすすめの試合順の特徴は以下のとおり。
  - 1ラウンドの定義は以下のとおり。
    - メンバーが偶数のとき、(メンバー / 2)試合を1ラウンドとする。
    - メンバーが奇数のとき、( (メンバー - 1) / 2)試合を1ラウンドとする。
    - メンバーが偶数の場合は、全メンバーが1ラウンドにつき1試合ある。
    - メンバーが奇数の場合は、1ラウンドにつき、試合のないメンバーが1人おり、それ以外のメンバーは1試合ある。
  - ラウンド毎に試合相手が変わる。
